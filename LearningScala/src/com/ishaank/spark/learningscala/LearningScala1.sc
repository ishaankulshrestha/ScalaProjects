object LearningScala1 {
  ...
  val hello: String = "Dist!"                     //> hello  : String = Dist!
  println(hello)                                  //> Dist!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Dist!
  helloThere = hello + " There!"
  println(helloThere)                             //> Dist! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Dist!There!
  println(immutableHelloThere)                    //> Dist!There!
